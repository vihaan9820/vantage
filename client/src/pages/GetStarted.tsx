...
export default function GetStarted() {
  ...
  return (
    <div className="vantage-landing-wrap min-h-screen relative flex flex-col justify-between overflow-x-hidden selection:bg-white selection:text-black">
      <PageSEO
        title="Get Started — Vantage Knowledge Barter"
        description="Begin your reciprocal 1-on-1 knowledge exchange on Vantage. Claim 20 starter points on registration to learn from verified creators and engineers."
      ...
      <header className="relative z-20 max-w-7xl w-full mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-6 flex items-center justify-between gap-2">
        <Link href="/" className="flex items-center gap-2.5 sm:gap-3 group shrink-0" aria-label="Vantage Home">
          <img
