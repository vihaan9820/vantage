      ...
      >
        ...
        <div
          style={{
            ...
            maxHeight: "600px",
            borderRadius: "50%",
            background: `radial-gradient(circle, ${colors[0] || "#ffffff"} 0%, rgba(255,255,255,0) 70%)`,
            animation: `glassFlowDrift1 ${animDuration} ease-in-out infinite alternate`,
          }}
        />

        {/* Blob 2 - Light gray flow */}
        <div
          style={{
            position: "absolute",
            top: "40%",
            ...
            maxHeight: "650px",
            borderRadius: "50%",
            background: `radial-gradient(circle, ${colors[1] || "#a1a1aa"} 0%, rgba(161,161,170,0) 70%)`,
            animation: `glassFlowDrift2 ${animDuration} ease-in-out infinite alternate-reverse`,
          }}
        />

        {/* Blob 3 - Mid gray flow */}
        <div
          style={{
            position: "absolute",
            bottom: "15%",
            ...
            maxHeight: "500px",
            borderRadius: "50%",
            background: `radial-gradient(circle, ${colors[2] || "#71717a"} 0%, rgba(113,113,122,0) 70%)`,
        ...
        {interactive && (
          <div
            style={{
              ...
              maxHeight: "400px",
              borderRadius: "50%",
              background: `radial-gradient(circle, ${colors[3] || "#ffffff"} 0%, rgba(255,255,255,0) 65%)`,
