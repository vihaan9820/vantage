...
export interface GradualBlurProps {
  ...
  easing?: string;
  opacity?: number;
  curve?: GradualBlurCurve | string;
  responsive?: boolean;
  target?: GradualBlurTarget | string;
...
const useIntersectionObserver = (ref: React.RefObject<HTMLElement | null>, shouldObserve = false) => {
  ...
  useEffect(() => {
    if (!shouldObserve || !ref.current || typeof IntersectionObserver === "undefined") return;
...
export type GradualBlurComponent = React.NamedExoticComponent<GradualBlurProps> & {
