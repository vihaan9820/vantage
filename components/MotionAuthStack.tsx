  ...
  return (
    <MotionConfig transition={{ type: "spring", bounce: 0.28, visualDuration: 0.4 }}>
      <motion.div animate={isVerifying ? "verifying" : "default"} className="clerk-stage relative w-full flex flex-col items-center">
        ...
        <div className="glow-orb-indigo w-80 h-80 top-10 left-1/4 opacity-30 pointer-events-none" />
        <div className="glow-orb-emerald w-80 h-80 bottom-10 right-1/4 opacity-25 pointer-events-none" />
